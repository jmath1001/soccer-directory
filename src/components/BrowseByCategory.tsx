...
const categories = [
  { id: 1, name: 'Full Field', image: '/images/full-field.jpg', type: 'full' },
  { id: 2, name: 'Small Sided', image: '/images/small-sided.jpg', type: 'small' },
  { id: 3, name: 'Open Play', image: '/images/open-play.jpg', type: 'open' },
];
