...
export default function SubmitFieldPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error } = await supabase.from('field_submissions').insert({
      ...formData,
      approved: false,
  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-12">
      ...
      <div className="bg-yellow-100 border border-yellow-300 text-yellow-800 p-4 rounded mb-6 text-sm">
        Fill out this form to submit a new soccer field to our platform. We&apos;ll review it and list it
        shortly. Our team may contact you to verify ownership.
      </div>
