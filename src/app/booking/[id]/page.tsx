...
export default function BookingPage() {
  ...
  function onDateChange(value: Value) {
  ...
  function tileClassName({ date, view }: { date: Date; view: string }): string | null {
    if (view === 'month') {
      const dateKey = formatDate(date);
      if (Object.prototype.hasOwnProperty.call(mockAvailability, dateKey)) {
    ...
    <div className="min-h-screen bg-white text-gray-900 p-4">
      ...
      <div className="mb-6 p-4 bg-gray-50 rounded shadow-sm max-w-md mx-auto">
        ...
        <p className="text-gray-700 text-sm">
          Please review our booking policies carefully before selecting a date. Cancellations must be
          made 24 hours in advance. Payment is required to confirm your booking.
        </p>
      </div>
      ...
      {selectedDate && (
        <div className="max-w-md mx-auto mt-6 px-4">
          ...
          <button
            ...
            onClick={() => router.push(`/payment/${id}?date=${formatDate(selectedDate)}`)}
